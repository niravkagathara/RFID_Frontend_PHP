...
<body>
    ...
    <main id="main" class="main">
        <table>
            <tr>
                    <td><h2>Edit/Update Student</h2></td><span></span>
...
?>
            ...
            <button type="submit" id="refreshButton" name="submit">Update Student</button>
        </form>
    </main>
    <p id="phpOutput"></p>
        ...
        async function fetchUID() {
            ...
            try {
                ...
                if (uid) {
                    ...
                    document.getElementById("uid_hidden").value = uid;
