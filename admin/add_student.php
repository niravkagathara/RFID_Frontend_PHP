...
if ($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST['submit'])) {
    $uidaa = isset($uid) ? $uid : 'null';
    $uida = isset($uid) ? $uid : 'null';
...
<body>
   <!-- ======= Header ======= -->
    ...
    <main id="main" class="main">
        ...
        <table>
            <tr>
                    <td> <h2>Add New Student</h2></td><span></span>
                    <td class="ml-4"><button type="button" onclick="window.location.href='index.php'" style="margin-left: 10px;">Back</button></td>
                    </tr>
        </table>
...
if ($uidaa === "null") {
    ...
    ?>
    <input type="text" id="uid" name="uid" disabled><br><br>
    <?php
}
?>
            <label>Name:</label>
            ...
            <button type="submit" id="refreshButton" name="submit">Add New Student</button>
        </form>
    </main>
    <p id="phpOutput"></p>
    ...
    // else{
    //     document.getElementById("uid").value = 'no uid found';
    // }
